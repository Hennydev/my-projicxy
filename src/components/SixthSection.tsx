...
const SixthSection = () => {
    return (
        <Box w={{ sm: "90%", md: "80%", lg: "80%", xl: "75%" }} mx={"auto"} my={"14"}>
            <Text textAlign={"center"} fontWeight={"bold"} fontSize={"4xl"} color={"#013a63"}>Your #1 paper writing service</Text>
            ...
            <HStack pos={"relative"} bg={"gray.200"} w={"full"} px={"2"} rounded={"xl"} py={"12"} my={"14"}>
                <VStack pos={"absolute"} bottom={"12"} left="-4" shadow={"2xl"}  py={"6"} bg={"white"} w={"28%"} px={"6"} border={"1px"} borderColor={"gray.200"} rounded={"2xl"}>
                ...
                <Box display="flex" justifyContent={"space-between"} ml={"72"} flexDir="row" alignItems={"center"} w={"70%"}>
                <UnorderedList >
